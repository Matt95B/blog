...
![]({{site.url}}/images/2023-08-10-Intune-UserGroup-to-DeviceCategory/EntraID-Group-ObjectID.png)

### 2. Intune Device Category Names
Identify the **exact display names** of the Intune device categories you want to assign.

![]({{site.url}}/images/2023-08-10-Intune-UserGroup-to-DeviceCategory/Intune-Device-Categories.png)
...
![]({{site.url}}/images/2023-08-10-Intune-UserGroup-to-DeviceCategory/EntraID-Group-DeviceQuery.png)
