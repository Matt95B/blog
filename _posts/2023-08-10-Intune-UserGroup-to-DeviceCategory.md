...
![EntraID-Group-ObjectID]({{site.url}}/images/2023-08-10-Intune-UserGroup-to-DeviceCategory/EntraID-Group-ObjectID.png)

### 2. Intune Device Category Names
Identify the **exact display names** of the Intune device categories you want to assign.

![Intune-Device-Categories]({{site.url}}/images/2023-08-10-Intune-UserGroup-to-DeviceCategory/Intune-Device-Categories.png)
...
![EntraID-Group-DeviceQuery]({{site.url}}/images/2023-08-10-Intune-UserGroup-to-DeviceCategory/EntraID-Group-DeviceQuery.png)
