...
- **A business-associated email address** to create the initial ABM Administrator account.  
  _Consumer email domains (Gmail, Yahoo, etc.) are not supported._
- **A verification contact** who can confirm your role and is authorised to bind your organisation to the ABM Terms and Conditions (typically a CIO, IT Director, or Procurement lead).

---

## Registration Steps

1. **Navigate to the enrollment portal**
   - Business: [business.apple.com](https://business.apple.com) → **Enroll now**
   - Education: [school.apple.com](https://school.apple.com)

2. **Provide Organisation Information**
...
3. **Provide Your Details**
   ...
   - **Recommendation:** Use a generic/corporate mailbox for the initial Administrator (e.g. `Apple.ABM@yourdomain.com`). This can be a shared mailbox or distribution group.

4. **Provide Verification Contact**
...
1. Log in to the ABM portal.
2. Navigate to **Accounts → Add New Account**.
3. Enter the user’s name, Managed Apple ID, email, role, and location.
...
1. Go to **Settings → Device Management Settings**.
2. Add your:
